        ...
        <div class="box-container">
            <div class="box">
                <div class="box-counter">
                    <p class="counter" data-speed="1000">5000 </p><i class='bx bx-plus'></i>
                </div>
...
<footer>
    <div class="content">
        ...
        <div class="box">
            <h3>contact us</h3>
            <p><i class='bx bxs-phone'></i>9119536144</p>
            <p><i class='bx bxs-envelope'></i>agc@gmail.com</p>
            <p><i class='bx bxs-location-plus'></i>Abasaheb Garware, Pune</p>
            <div class="icons">
