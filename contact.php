...
<body>
	...
	<div class="services">
		<div class="heading">
			<h1>our services</h1>
			<p style="text-align: center;">Just A Few Click To Make The Reservation Online For Saving Your Time And
				Money</p>
			...
			<form action="" method="post" class="register">
				...
				<div class="input-field">
					...
					<textarea name="message" cols="30" rows="10" required
						placeholder="add any comment you think necessary"></textarea>
				</div>
	...
	<div class="address">
		...
		<div class="box-container">
			<div class="box">
				...
				<div>
					<h4>address</h4>
					<p>Abasaheb Garware<br>Pune, 411002</p>
				</div>
			</div>
			<div class="box">
